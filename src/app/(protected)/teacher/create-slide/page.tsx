    ...
    return (
        <section className="w-full flex flex-col items-center justify-center mt-[5rem] mb-[10rem]">
                    ...
                    <div className="group rounded-xl border border-blue-500/20 bg-blue-500/[0.02] p-5 hover:border-blue-400/40 hover:bg-blue-500/[0.05] transition-all duration-200">
                        ...
                        <div className="flex items-stretch gap-2">
                            ...
                            <button
                                ...
                                className={`w-[92px] shrink-0 rounded-lg border flex flex-col items-center justify-center px-2 py-3 transition-all ${isRecordingVoice
                    ...
                    <div className="group rounded-xl border border-blue-500/20 bg-blue-500/[0.02] p-5 hover:border-blue-400/40 hover:bg-blue-500/[0.05] transition-all duration-200">
                        ...
                        <div className="flex items-stretch gap-2">
                            ...
                            <button
                                ...
                                className={`w-[92px] shrink-0 rounded-lg border flex flex-col items-center justify-center px-2 py-3 transition-all ${isTranscribing
            ...
            <div className="w-full max-w-[1680px] px-4 md:px-6 lg:px-8 mt-6 flex flex-col items-center">
                ...
                {createVideoHint && (
                    <p
                        className={`mt-2 text-sm text-red-500 transition-opacity duration-500 ${isCreateVideoHintVisible ? 'opacity-100' : 'opacity-0'
                            }`}
                    >
                        {createVideoHint}
                    </p>
