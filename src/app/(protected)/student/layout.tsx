    ...
    return (
        ...
        >
            <div className="w-[var(--global-width)] flex items-center justify-between">
                ...
                <div className="flex items-center justify-end w-full h-[10rem]">
                    <div className="flex items-center justify-center w-[10rem] h-full" style={{}}>
                        <Dropdown
                        ...
                        >
                            <Button className="!h-[10rem] !w-[10rem] !rounded-full !border-none !flex !items-center !justify-center !relative">
...
const NAV_ITEMS = [
    { key: "homepage", label: "Trang chủ", path: "/student/home" },
    { key: "courses",  label: "Môn học",   path: "/student/courses" },
    // { key: "courses",  label: "Môn học",   path: "/student/courses" },

];

const DynamicStudentNavbar = () => {
    const [showLogoutModal, setShowLogoutModal] = useState(false);
    ...
    const NotifBtn = () => (
        <Dropdown 
            menu = {{items:notificationItems}} trigger = {['click']}
            placement="bottomRight"
            ...
            >
                ...
                <div className="py-1">
                    ...
                    {[
                        ...
                        { label: 'Quá trình học',  path: '/student/learning-progress' },
                    ].map(({ label, path }) => (
